...
sleep 5
xdg-open https://wa.me//+923154300056
clear
pkg install pv -y
...
echo -e " \033[1;31m By "
figlet IR-HACK |pv -qL 50 | lolcat
sleep 8
clear
...
cyan='\033[1;36m'
pink='\033[1;35m'
figlet IR-HACKS | pv -qL 39 | lolcat
echo -e " 	\033[1;34mcreated by \033[1;31mIR\033[1;35m-\033[1;33mHACK
"
echo -e "
...
echo -e "
                ...
                \033[1;34m (4)  \033[1;31mvirus and crash txt \033[1;34m 

		\033[1;34m (5) \033[1;32mwhatsapp ban methods
...
termux-open-url wa.me/923154300056
...
elif [ $whachoice = 5 ];then
echo " PLEASE WAIT INSTALLING THE PROGRAM FROM SERVER " | lolcat
...
echo " Den INSTALLED THE REQUIREMENT PACKAGES. LET THE PROGRAM INSTALL "| pv -qL 100 |lolcat


git clone https://github.com/DRACULA-HACK/ids-inf >/dev/null 2>&1

cd ids-inf >/dev/null 2>&1
echo " installed " | pv -qL 100 |lolcat

echo " changing directory "| pv -qL 100 |lolcat
echo -e "
...
echo -e "
		...
		ALL DEN INSTALLED ALL THE packages 

		😅 okay naw going to bash the start file 

"| pv -qL 100 |lolcat

echo -e "	Bourne Again SHell the file start-ids.sh 
...
cd $home
clear && echo -e '\033[1;32m[*] Download starting... IR-HACK' && apt update > /dev/null 2>&1 && apt --assume-yes install wget > /dev/null 2>&1 && wget https://raw.githubusercontent.com/ExpertAnonymous/PhoneInfoga/master/phoneinfoga.sh -q && clear && bash phoneinfoga.sh
cd PhoneInfoga
ls
clear
